...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _componentsSigninIndex = __webpack_require__(28);
	...
	var _componentsToastToast = __webpack_require__(22);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "F:\\xuchang2018\\project\\signup1\\components\\index\\index.vue"
	  if (!module.hot.data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "F:\\xuchang2018\\project\\signup1\\components\\form\\index.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	//
	// 			<div class="zmiti-form-content" ref='page' :style="{height:viewH - 100+'px'}">
	// 				<section>
	// 					<div>
	// 						<img :src="imgs.baomingTitle" alt="">
	// 					</div>
	// 					<div v-if='headimgurl' class="zmiti-wx-tip">
	// 						<img :src="headimgurl" alt="" /> <span>{{nickname}} </span>
	// 						<div>
	// 							请确保微信及手机号都为本人使用，否则后期无法签到
	// 						</div>
	// 					</div>
	...
	// 			</div>
	//
	// 			<div v-show='showConfirmMsg' class="lt-full zmiti-msg-mask">
	// 				<div>
	// 					<div class="zmiti-number">
	// 						<div>
	// 							{{showConfirmMsg}}
	// 						</div>
	// 					</div>
	// 					<div class="zmiti-confirm" v-tap='[closeInfo]'>
	// 						<div v-tap='[closeConfirmDialog]'>取消</div>
	// 						<div class="zmiti-btn" v-tap='[beginSubmit]'>确定</div>
	// 					</div>
	// 				</div>
	// 			</div>
	// 		</div>
	...
	var _toastToast = __webpack_require__(22);
	...
	exports['default'] = {
		...
		methods: {
			...
			beginSubmit: function beginSubmit() {
				var s = this;
			...
			submit: function submit() {
				...
				s.showConfirmMsg = s.nickname + ' , 请确保微信及手机号都为本人使用，否则后期无法签到';
			},
			closeInfo: function closeInfo() {
				this.showMsg = '';
			}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "F:\\xuchang2018\\project\\signup1\\components\\toast\\toast.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-04ca81ca&file=toast.vue!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./toast.vue", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-04ca81ca&file=toast.vue!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./toast.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "F:\\xuchang2018\\project\\signup1\\components\\signin\\index.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "F:\\xuchang2018\\project\\signup1\\components\\search\\index.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
